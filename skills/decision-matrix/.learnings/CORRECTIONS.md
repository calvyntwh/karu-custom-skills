...
This file is a one-time-per-incident log of corrections to decision-matrix — instances where the skill's protocol produced a wrong outcome that the author caught or was caught by review. Format adapted from Google SRE blameless post-mortem template (sre.google/sre-book/postmortem-culture) and Etsy Debriefing Facilitation Guide.
